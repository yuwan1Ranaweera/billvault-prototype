...
export function IndividualLogin({ onBack, onLogin, onSignUp }: IndividualLoginProps) {
  ...
  return (
    <div className="w-full h-full bg-gradient-to-br from-slate-50 to-purple-50 relative">
      ...
      <div className="flex items-center justify-between px-6 pt-4 pb-8">
        ...
        <h1 className="text-lg font-semibold text-slate-900">Individual Sign In</h1>
      ...
      <div className="px-6">
        <div className="text-center mb-8">
          ...
          >
            <div className="text-2xl font-bold text-white">U</div>
          </div>
          <h2 className="text-3xl font-bold text-slate-900 mb-2">Welcome back</h2>
          <p className="text-slate-600">Sign in to your personal BillVault account</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="text-right">
            <Button variant="link" className="p-0 h-auto text-sm font-medium" style={{ color: "#9B7EBD" }}>
              Forgot password?
            </Button>
          </div>
          ...
          <div className="text-center pt-6">
            ...
            <Button variant="link" onClick={onSignUp} className="p-0 h-auto font-semibold" style={{ color: "#9B7EBD" }}>
              Sign up
            </Button>
          </div>
          ...
          <div className="mt-8 p-4 bg-white/50 rounded-2xl border border-slate-200">
            <h4 className="font-semibold text-slate-900 mb-3">Individual Features:</h4>
